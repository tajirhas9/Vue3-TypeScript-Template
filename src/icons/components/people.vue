<template>
	<!-- <svg version="1.1" :viewBox="viewBox" class="international-icon svg-icon svg-fill" style="width: 1rem; height: 1rem"> -->
	<svg width="1.5rem" height="1.5rem" viewBox="0 5 48 48">
		<g fill="currentColor">
			<path
				fill-rule="evenodd"
