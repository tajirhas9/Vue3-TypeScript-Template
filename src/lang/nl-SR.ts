export default {
	route: {
		...
		queue: 'Queue',
		forms: 'Forms',
		ADMSEARCH: 'Admission Search Form',
		SCO_CRIBII: 'CRIB-II Score Form',
		...
		icons: 'Icons',
		patient: 'Dashboard', // 'Patient', // Added by Joe
	...
	login: {
		...
		loading: 'Geauthenticeerd. Data ophalen...',
		failed: 'verkeerde gebruikersnaam of wachtwoord',
	},
	documentation: {
		documentation: 'Documentation',
	...
	info: {
		siteName: 'Student Mail Monitoring System',
	},
	configuration: {
		name: 'Name',
		section: 'Section',
